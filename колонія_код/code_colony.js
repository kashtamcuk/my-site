        ...
        <div class="about-wrapper" style="display: flex; gap: 30px; margin-bottom: 40px; align-items: stretch; height: auto;">
            ...
            <!-- Блок з фото: обмежуємо ширину до 45% і фіксуємо висоту -->
            <div class="about-image" style="flex: 0 0 45%; max-width: 45%; overflow: hidden; border: 1px solid var(--accent); position: relative;">
                <img src="фото_місія_марс/mars_base_hq.png" alt="Mars HQ" style="width: 100%; height: 100%; object-fit: cover; display: block; filter: contrast(1.1) brightness(0.9);">
                <!-- Декоративний кут для стилю -->
